# Checklist fil rouge — Couverture des objectifs (Ex. 1 à 4)

Croisement des points ● de la formation (`.memory/00-presentation.md`) avec les exercices 1 à 4.  
**Ex. n** = exercice 1 à 4 | **Exposé** = théorie / démo | **—** = non couvert par un exo (exposé ou à prévoir).
...
| ● Rôles de comptes de service | Exposé |
